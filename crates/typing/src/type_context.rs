...
impl TypeContext {
    pub fn new() -> Self {
        ...
        let core_types = CoreTypes {
            ...
            boolean: types.get_or_add(Type::Primitive(PrimitiveType::Boolean)),
            int8: types.get_or_add(Type::Primitive(PrimitiveType::Int(IntType::I8))),
            int16: types.get_or_add(Type::Primitive(PrimitiveType::Int(IntType::I16))),
            int32: types.get_or_add(Type::Primitive(PrimitiveType::Int(IntType::I32))),
            int64: types.get_or_add(Type::Primitive(PrimitiveType::Int(IntType::I64))),
            int_size: types.get_or_add(Type::Primitive(PrimitiveType::Int(IntType::ISize))),
            uint8: types.get_or_add(Type::Primitive(PrimitiveType::UInt(UIntType::U8))),
            uint16: types.get_or_add(Type::Primitive(PrimitiveType::UInt(UIntType::U16))),
            uint32: types.get_or_add(Type::Primitive(PrimitiveType::UInt(UIntType::U32))),
            uint64: types.get_or_add(Type::Primitive(PrimitiveType::UInt(UIntType::U64))),
            uint_size: types.get_or_add(Type::Primitive(PrimitiveType::UInt(UIntType::USize))),
            float: types.get_or_add(Type::Primitive(PrimitiveType::Float)),
            component: types.get_or_add(Type::Primitive(PrimitiveType::Component)),
